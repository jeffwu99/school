...
int main() {
	...
	//testing insertionsort here
	cout << "arr1: " << insertionsort(arr, TESTSIZE) << endl;
	cout << "arr2: " << insertionsort(arr2, TESTSIZE) << endl;
	cout << "arr3: " << insertionsort(arr3, TESTSIZE) << endl;
	cout << "arr4: " << insertionsort(arr4, TESTSIZE2) << endl;
	cout << "arr5: " << insertionsort(arr5, TESTSIZE2) << endl;
	cout << "arr6: " << insertionsort(arr6, TESTSIZE2) << endl;
	cout << "arr7: " << insertionsort(arr7, TESTSIZE3) << endl;
	cout << "arr8: " << insertionsort(arr8, TESTSIZE3) << endl;
	cout << "arr9: " << insertionsort(arr9, TESTSIZE3) << endl;
	cout << "arr10: " << insertionsort(arr10, TESTSIZE4) << endl;
	cout << "arr11: " << insertionsort(arr11, TESTSIZE4) << endl;
	cout << "arr12: " << insertionsort(arr12, TESTSIZE4) << endl;
	cout << "arr13: " << insertionsort(arr13, TESTSIZE5) << endl;
	cout << "arr14: " << insertionsort(arr14, TESTSIZE5) << endl;
	cout << "arr15: " << insertionsort(arr15, TESTSIZE5) << endl;
	cout << "arr16: " << insertionsort(arr16, TESTSIZE6) << endl;
	cout << "arr17: " << insertionsort(arr17, TESTSIZE6) << endl;
	cout << "arr18: " << insertionsort(arr18, TESTSIZE6) << endl;
	cout << "arr19: " << insertionsort(arr19, TESTSIZE7) << endl;
	cout << "arr20: " << insertionsort(arr20, TESTSIZE7) << endl;
	cout << "arr21: " << insertionsort(arr21, TESTSIZE7) << endl;
	cout << "arr22: " << insertionsort(arr22, TESTSIZE8) << endl;
	cout << "arr23: " << insertionsort(arr23, TESTSIZE8) << endl;
	cout << "arr24: " << insertionsort(arr24, TESTSIZE8) << endl;
	cout << "arr25: " << insertionsort(arr25, TESTSIZE9) << endl;
	cout << "arr26: " << insertionsort(arr26, TESTSIZE9) << endl;
	cout << "arr27: " << insertionsort(arr27, TESTSIZE9) << endl;
	cout << "arr28: " << insertionsort(arr28, TESTSIZE10) << endl;
	cout << "arr29: " << insertionsort(arr29, TESTSIZE10) << endl;
	cout << "arr30: " << insertionsort(arr30, TESTSIZE10) << endl;

	//strings
	cout << "arr91: " << insertionsort(arr91, TESTSIZE91) << endl;
	cout << "arr92: " << insertionsort(arr92, TESTSIZE92) << endl;
	cout << "arr93: " << insertionsort(arr93, TESTSIZE93) << endl;
	cout << "arr94: " << insertionsort(arr94, TESTSIZE94) << endl;
	cout << "arr95: " << insertionsort(arr95, TESTSIZE95) << endl;
	cout << "arr96: " << insertionsort(arr96, TESTSIZE96) << endl;
	cout << "arr97: " << insertionsort(arr97, TESTSIZE97) << endl;
