...
int main() {
	...
	cout << "arr1: " << quicksort(arr, TESTSIZE) << endl;
	cout << "arr2: " << quicksort(arr2, TESTSIZE) << endl;
	cout << "arr3: " << quicksort(arr3, TESTSIZE) << endl;
	cout << "arr4: " << quicksort(arr4, TESTSIZE2) << endl;
	cout << "arr5: " << quicksort(arr5, TESTSIZE2) << endl;
	cout << "arr6: " << quicksort(arr6, TESTSIZE2) << endl;
	cout << "arr7: " << quicksort(arr7, TESTSIZE3) << endl;
	cout << "arr8: " << quicksort(arr8, TESTSIZE3) << endl;
	cout << "arr9: " << quicksort(arr9, TESTSIZE3) << endl;
	cout << "arr10: " << quicksort(arr10, TESTSIZE4) << endl;
	cout << "arr11: " << quicksort(arr11, TESTSIZE4) << endl;
	cout << "arr12: " << quicksort(arr12, TESTSIZE4) << endl;
	cout << "arr13: " << quicksort(arr13, TESTSIZE5) << endl;
	cout << "arr14: " << quicksort(arr14, TESTSIZE5) << endl;
	cout << "arr15: " << quicksort(arr15, TESTSIZE5) << endl;
	cout << "arr16: " << quicksort(arr16, TESTSIZE6) << endl;
	cout << "arr17: " << quicksort(arr17, TESTSIZE6) << endl;
	cout << "arr18: " << quicksort(arr18, TESTSIZE6) << endl;
	cout << "arr19: " << quicksort(arr19, TESTSIZE7) << endl;
	cout << "arr20: " << quicksort(arr20, TESTSIZE7) << endl;
	cout << "arr21: " << quicksort(arr21, TESTSIZE7) << endl;
	cout << "arr22: " << quicksort(arr22, TESTSIZE8) << endl;
	cout << "arr23: " << quicksort(arr23, TESTSIZE8) << endl;
	cout << "arr24: " << quicksort(arr24, TESTSIZE8) << endl;
	cout << "arr25: " << quicksort(arr25, TESTSIZE9) << endl;
	cout << "arr26: " << quicksort(arr26, TESTSIZE9) << endl;
	cout << "arr27: " << quicksort(arr27, TESTSIZE9) << endl;
	cout << "arr28: " << quicksort(arr28, TESTSIZE10) << endl;
	cout << "arr29: " << quicksort(arr29, TESTSIZE10) << endl;
	cout << "arr30: " << quicksort(arr30, TESTSIZE10) << endl;

	//strings
	cout << "arr91: " << quicksort(arr91, TESTSIZE91) << endl;
	cout << "arr92: " << quicksort(arr92, TESTSIZE92) << endl;
	cout << "arr93: " << quicksort(arr93, TESTSIZE93) << endl;
	cout << "arr94: " << quicksort(arr94, TESTSIZE94) << endl;
	cout << "arr95: " << quicksort(arr95, TESTSIZE95) << endl;
	cout << "arr96: " << quicksort(arr96, TESTSIZE96) << endl;
	cout << "arr97: " << quicksort(arr97, TESTSIZE97) << endl;
